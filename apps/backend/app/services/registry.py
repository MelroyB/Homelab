...
SERVICE_CATALOG: list[ServiceMeta] = [
    ...
    ServiceMeta(
        ...
        name="Mail Server",
        category="messaging",
        description="SMTP/IMAP mail service with DKIM signing support",
        container_name="homelab-mailserver-1",
        config_path="/var/lib/homelab/config/mailserver/mailserver.env",
        template_name="mailserver.j2",
    ),
    ServiceMeta(
        slug="webmail",
        name="Webmail",
